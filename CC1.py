...
class CC1:
    def __init__(self):
        self.fhLog = open("logs/CC1Log", "a+")
        self.fhLog.write("====================\n")
        self.fhLog.write(str(time.time()) + " CC1 is running\n")
    ...
    def checkZombies(self):
        ...
        if down > 0:
            ...
            fhCCC.close()
            self.fhLog.write(
                str(time.time()) + "CC1 cleared CC communication channel, send message to master, we have " + str(
                    down) + " zombies down\n")
